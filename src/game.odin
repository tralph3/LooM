...
game_entries_load :: proc (allocator:=context.allocator) {
    ...
    append(&GLOBAL_STATE.game_entries, GameEntry{core="./cores/b2_libretro.so", path=""})
    append(&GLOBAL_STATE.game_entries, GameEntry{core="./cores/puae_libretro.so", path=""})
    append(&GLOBAL_STATE.game_entries, GameEntry{core="/home/tralph3/Projects/thirdparty/libretro-samples/video/opengl/libretro_test_gl_compute_shaders/testgl_compute_shaders_libretro.so", path=""})
