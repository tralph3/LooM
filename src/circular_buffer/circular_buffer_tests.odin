...
circular_buffer_can_push_and_pop :: proc (t: ^testing.T) {
    ...
    push(&cb, &data, size_of(u32))
    testing.expect_value(t, cb.size, 4)
    pop(&cb, result, size_of(u32))
